...
const CHARACTERS = {
  bro_bao: {
    ...
    // LEO handoff 定稿：教官音色 + 约 1.15x 语速
  ...
  uncle_bao: {
    name: "豹叔",
    imageUrl:
      "https://bpuqqyqmrtchaqfouygm.supabase.co/storage/v1/object/public/assets/uncle_bao_master_v2.png",
...
async function insertCourseVideo({
  ...
  const sb = await getSupabase();
  // 仅写现网 course_videos 基线列 + published_at；NULL = draft，永不自动发布
