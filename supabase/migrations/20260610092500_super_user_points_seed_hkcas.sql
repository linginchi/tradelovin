-- 超级用户 william.hu@hkcas.org / lin@hkcas.org 积分设为 100 万并升 T3（幂等）
...
BEGIN
  FOREACH v_email IN ARRAY ARRAY['william.hu@hkcas.org', 'lin@hkcas.org']
  LOOP
    ...
    IF v_user_id IS NULL THEN
      RAISE NOTICE 'Super user % not found; skipping points seed', v_email;
      CONTINUE;
    END IF;
