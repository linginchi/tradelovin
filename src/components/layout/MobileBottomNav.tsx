...
const NAV_ITEMS = [
	...
	{ href: "/my-scores", label: "我的成绩", icon: Medal },
	{ href: "/my-profile", label: "我的", icon: UserRound },
] as const;
...
export default function MobileBottomNav() {
	...
	return (
		<nav
			...
			aria-label="主导航"
		>
			<ul className="mx-auto flex max-w-lg items-stretch justify-around gap-1 px-2 py-2 lg:max-w-none lg:gap-2 lg:py-1">
